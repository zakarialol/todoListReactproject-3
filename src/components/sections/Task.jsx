...
function Task({taskText,type,className="",date="dd/mm/yyyy",setTasks,tasks,setEdit,task,setSelectedTask,setValue,setSelected,hide}){
    //
    ...
    return(
        <div className="py-5 border-[(RGA(0_0_0_/.15))] border-b font-inter">
            <div className="flex justify-between gap-2 mb-3">
                <p className="text-[#121212] text-[17px]">{FirstLetterUpperFunc(taskText)}</p>
                <TaskActions setEdit={setEdit} setValue={setValue} setSelectedTask={setSelectedTask} setSelected={setSelected} tasks={tasks} setTasks={setTasks} hide={hide} task={task}/>
            </div>
